...
{
   throw runtime_error("Binop_Node::check_symbol() is not yet implemented");
}

void Unop_Node::check_symbols()
{
   throw runtime_error("Unop_Node::check_symbol() is not yet implemented");
}

void Decl_Node::build_symtab()
{
   throw runtime_error("Decl_Node::build_symtab() is not yet implemented");
}

void Vble_Node::check_symbols()
{
   throw runtime_error("Vble_Node::check_symbol() is not yet implemented");
}

void Assign_Node::check_symbols()
{
   throw runtime_error("Assign_Node::check_symbol() is not yet implemented");
}

void Xchg_Node::check_symbols()
{
   throw runtime_error("Xchg_Node::check_symbol() is not yet implemented");
}

void If_Node::check_symbols()
{
   throw runtime_error("If_Node::check_symbol() is not yet implemented");
}

void While_Node::check_symbols()
{
   throw runtime_error("While_Node::check_symbol() is not yet implemented");
}

void IO_Node::check_symbols()
{
   throw runtime_error("IO_Node::check_symbol() is not yet implemented");
}

void Prog_Node::build_symtab()
{
   throw runtime_error("Prog_Node::build_symtab() is not yet implemented");
}

void Prog_Node::check_symbols()
{
   throw runtime_error("Prog_Node::check_symbol() is not yet implemented");
}
